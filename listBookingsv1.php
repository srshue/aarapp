...
<body onload="IMinit()" >
<h1  text-align: right;>Bookings  <a href='logout.php'>logout</a></h1>
<?php
...
foreach ($rowsToIterate as $row) {
    ...
    echo "<td><a href='details.php?eventID=".(isset($row['EventID'])?$row['EventID']:'')."' style='text-decoration:none;padding:6px 10px;background:#4CAF50;color:#fff;border-radius:6px;'>Details</a></td>";
